...
})(ElementSegmentMode || (ElementSegmentMode = {}));
export var DataSegmentMode;
...
})(DataSegmentMode || (DataSegmentMode = {}));
    ...
    readInstruction() {
        ...
        switch (opcode) {
            ...
            case 68:
                ...
                break;
            default:
                this.assert(Opstring.hasOwnProperty(opcode), "Unsupported instruction");
        }
        return {
            opcode,
...
export class WasmModule {
    ...
    static decodeFrom(buffer) {
        ...
        while (reader.inBuffer()) {
            ...
            reader.assert(!SectionOrder.includes(id) || newOrderPos > orderPos, "Section " + id + " may not occur after " + SectionOrder[orderPos]);
